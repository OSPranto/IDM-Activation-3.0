...
::============================================================================
:: OSPranto Tech IDM Activation Script (Activator + Registry Cleaner)
::============================================================================

mode con: cols=120 lines=40
title OSPranto Tech IDM Activation Script (Activator + Registry Cleaner) v%iasver%
...
echo:			OSPranto Tech
echo:
echo:               Telegram: @MrMysteryMoon
echo:               Github: https://github.com/OSPranto
echo %GREEN%  ======================================================
echo %GREEN%    :                                                :
